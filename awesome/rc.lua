...
tags = {
    names = { "main", "code", "term", "www", "mail", "im", "music", "other" },
    layout = { layouts[1], layouts[2], layouts[2], layouts[5], layouts[5], layouts[4],
               layouts[5], layouts[1], }
}
...
mymainmenu = awful.menu({ items = { { "Debian", debian.menu.Debian_menu.Debian },
                                    ...
                                    { "Power off", awful.util.getdir("config") .. "/poweroff_dialog.sh" }
                                  }
                        })
